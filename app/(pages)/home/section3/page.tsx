...
import About1 from '../../../../public/assets/images/about-1.webp';
import About2 from '../../../../public/assets/images/about-2.png';
import About3 from '../../../../public/assets/images/about-3.webp';
import About4 from '../../../../public/assets/images/about-4.webp';
import Pattern1 from '../../../../public/assets/images/pattern-1.webp';
...
export default function Section3() {
  ...
  return (
    <section className="overflow-hidden text-body">
      <div className='section-padding-primary overflow-hidden'>
        <div className='grid items-center gap-12 lg:grid-cols-[.92fr_1fr] 2xl:gap-20'>
          <div className='lg:order-2 aos-init aos-animate pe-8' data-aos="fade-left" data-aos-delay="200">
            ...
            <div className='mt-7 grid gap-5 text-white sm:grid-cols-2 md:mt-10 md:gap-[1.875rem]'>
              <div className='group flex min-h-[64px] items-center gap-5 rounded border border-primary px-6 py-2 md:min-h-[85px] md:px-[1.875rem] md:py-3'>
                ...
                <h3 className='text-md font-secondary font-bold leading-[1.25] md:text-lg'>Cloud Migrate Pro</h3>
              </div>
              <div className='group flex min-h-[64px] items-center gap-5 rounded border border-primary px-6 py-2 md:min-h-[85px] md:px-[1.875rem] md:py-3'>
                <span className='duration flex-none scale-100 transition-transform ease-linear group-hover:scale-90'>
                ...
                <h3 className='text-md font-secondary font-bold leading-[1.25] md:text-lg'>AI Forge Labs</h3>
              </div>
            </div>
          ...
          <div className='mx-auto text-center'>
            <div className='relative mx-auto grid max-w-[580px] grid-cols-2 gap-2.5 overflow-hidden'>
                ...
                <div className='absolute left-1/2 top-1/2 z-[4] -translate-x-1/2 -translate-y-1/2 overflow-hidden'>
                    <div className='aos-init aos-animate' data-aos="zoom-in" data-aos-delay="450">
