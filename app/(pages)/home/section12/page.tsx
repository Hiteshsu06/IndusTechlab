            ...
            <SwiperSlide>
                <div className="relative whitespace-normal rounded-5 font-secondary bg-[#1a1a1c] p-6 lg:p-10">
                    <div className="flex items-center gap-5">
                        ...
                        <h3 className="h3 text-white text-[24px]">Customized Problem-Solving</h3>
                    </div>
                    <p className="mt-6 text-white">
                        Tailored solutions designed to meet unique business needs, ensuring smooth operations and long-term success.
                    </p>
                    <div className="mt-7 pr-[120px] text-primary">
                        <div className="relative z-[2] overflow-hidden text-base leading-[1.1] font-bold font-secondary tracking-wide [transition:all_0.3s_linear] inline-flex items-center justify-center md:min-h-[3.75rem] px-6 md:px-7 py-2 md:py-3 transition-colors ease-in-out ring-offset-primary-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 after:absolute after:h-full after:w-0 after:bottom-0 after:right-0 after:bg-black/[.15] after:-z-1 after:[transition:all_.3s_ease-in-out] hover:after:w-full hover:after:left-0 rounded-5 !min-h-fit gap-2.5 bg-transparent !p-0 uppercase text-accent-800 hover:bg-transparent text-primary hover:text-white after:hidden">
                            <span>READ MORE</span>
                            <span>IC</span>
                        </div>
                        <span className="absolute -bottom-5 right-5 z-1 text-[68px] font-bold text-white/10">01</span>
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide>
                <div className="relative whitespace-normal rounded-5 font-secondary bg-[#1a1a1c] p-6 lg:p-10">
                    ...
                    <div className="mt-7 pr-[120px] text-primary">
                        ...
                        <span className="absolute -bottom-5 right-5 z-1 text-[68px] font-bold text-white/10">02</span>
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide>
                <div className="relative whitespace-normal rounded-5 font-secondary bg-[#1a1a1c] p-6 lg:p-10">
                    ...
                    <div className="mt-7 pr-[120px] text-primary">
                        ...
                        <span className="absolute -bottom-5 right-5 z-1 text-[68px] font-bold text-white/10">03</span>
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide>
                <div className="relative whitespace-normal rounded-5 font-secondary bg-[#1a1a1c] p-6 lg:p-10">
                    ...
                    <div className="mt-7 pr-[120px] text-primary">
                        ...
                        <span className="absolute -bottom-5 right-5 z-1 text-[68px] font-bold text-white/10">04</span>
                    </div>
                </div>
            </SwiperSlide>
        </Swiper>
