...
export default function Header() {
  return (
    <header className="left-0 right-0 top-0 z-[100] mx-auto w-full py-[26px] lg:block absolute px-8">
      <div className="container_container__az_fT">
        <div className="flex items-center justify-between gap-x-10">
          ...
          <nav aria-label="primary navigation">
            <ul className="flex items-center gap-x-6">
              <li className="group/menu-item relative">
                <Link className="group-hover/menu-item:text-primary text-base leading-[1.3] capitalize py-4 min-h-[3.5rem] font-medium text-white hover:text-primary transition-colors duration-200 inline-flex items-center justify-center gap-1.5 focus:text-primary menu-link cursor-pointer" href="/">
                    <span className='text-[1rem]'>Home</span>
                </Link>
              </li>
              <li className="group/menu-item relative ">
                <Link className="group-hover/menu-item:text-primary text-base leading-[1.3] capitalize py-4 min-h-[3.5rem] font-medium text-white hover:text-primary transition-colors duration-200 inline-flex items-center justify-center gap-1.5 focus:text-primary menu-link cursor-pointer" href="/about">
                    <span className='text-[1rem]'>About</span>
                </Link>
              </li>
              <li className="group/menu-item relative ">
                <Link className="group-hover/menu-item:text-primary text-base leading-[1.3] capitalize py-4 min-h-[3.5rem] font-medium text-white hover:text-primary transition-colors duration-200 inline-flex items-center justify-center gap-1.5 focus:text-primary menu-link cursor-pointer" href="/service">
                    <span className='text-[1rem]'>Services</span>
                </Link>
              </li>
              <li className="group/menu-item relative ">
                <Link className="group-hover/menu-item:text-primary text-base leading-[1.3] capitalize py-4 min-h-[3.5rem] font-medium text-white hover:text-primary transition-colors duration-200 inline-flex items-center justify-center gap-1.5 focus:text-primary menu-link cursor-pointer" href="/project">
          ...
          <div className="contact-box flex items-center gap-4 text-white xl:flex">
            <svg
              className="flex-none"
              width="56"
              height="56"
