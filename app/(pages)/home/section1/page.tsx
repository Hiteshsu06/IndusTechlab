        ...
        <SwiperSlide>
          ...
          >
            <div className="relative flex items-center justify-center overflow-hidden py-[9.375rem] lg:min-h-screen">
              ...
              <div
                className="pointer-events-none absolute z-1 bottom-0 left-0 right-0 mx-auto hidden lg:block aos-init aos-animate"
                data-aos="fade-up"
                data-aos-delay="450"
              >
                <Image
              ...
              <div
                className="absolute inset-0 -z-1 bg-accent-700 bg-cover bg-no-repeat bg-blend-luminosity [background-position:top_center] [transform:scale(1)] [transition:7000ms_ease,opacity_1500ms_ease-in] hero_hero-bg__S4_7j before:absolute before:inset-0 before:opacity-80 before:bg-accent-900 after:absolute after:inset-0 after:[background:linear-gradient(180deg,rgba(20,20,22,0.00)_0%,#141416_100%)]"
                style={{
                  backgroundImage: "url(/assets/images/home-bg-2.jpg)",
                }}
              ></div>
              <div className="container_container__az_fT">
                <div className="relative z-10 mx-auto max-w-[940px] text-center text-white lg:mt-[60px]">
          ...
          >
            <div className="relative flex items-center justify-center overflow-hidden py-[9.375rem] lg:min-h-screen">
              ...
              <div
                className="absolute inset-0 -z-1 bg-accent-700 bg-cover bg-no-repeat bg-blend-luminosity [background-position:top_center] [transform:scale(1)] [transition:7000ms_ease,opacity_1500ms_ease-in] hero_hero-bg__S4_7j before:absolute before:inset-0 before:opacity-80 before:bg-accent-900 after:absolute after:inset-0 after:[background:linear-gradient(180deg,rgba(20,20,22,0.00)_0%,#141416_100%)]"
                style={{
                  backgroundImage: "url(/assets/images/hero-11.jpeg)",
                }}
              ></div>
              <div className="container_container__az_fT">
                <div className="relative z-10 mx-auto max-w-[940px] text-center text-white lg:mt-[60px]">
          ...
          >
            <div className="relative flex items-center justify-center overflow-hidden py-[9.375rem] lg:min-h-screen">
              ...
              <div
                className="absolute inset-0 -z-1 bg-accent-700 bg-cover bg-no-repeat bg-blend-luminosity [background-position:top_center] [transform:scale(1)] [transition:7000ms_ease,opacity_1500ms_ease-in] hero_hero-bg__S4_7j before:absolute before:inset-0 before:opacity-80 before:bg-accent-900 after:absolute after:inset-0 after:[background:linear-gradient(180deg,rgba(20,20,22,0.00)_0%,#141416_100%)]"
                style={{
                  backgroundImage: "url(/assets/images/home-bg.jpeg)",
                }}
              ></div>
              <div className="container_container__az_fT">
                <div className="relative z-10 mx-auto max-w-[940px] text-center text-white lg:mt-[60px]">
