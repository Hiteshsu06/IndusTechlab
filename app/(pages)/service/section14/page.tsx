...
import service6 from '../../../../public/assets/images/service6.webp';
import ServiceMain from '../../../../public/assets/images/service-main.webp';
import service7 from '../../../../public/assets/images/service7.webp';
import service8 from '../../../../public/assets/images/service8.webp';
import service9 from '../../../../public/assets/images/service9.webp';

export default function Section14() {
  return (
    <section className="section-padding-primary px-8">
      <div className="text-body">
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            <div className="grid gap-6 rounded-5 bg-accent-100 px-10 py-[30px] bg-accent-700">
              <h3 className="text-[1.5rem] text-white font-secondary">
                Our Service
              </h3>
              <ul className="grid gap-3" aria-label="service list">
                <li>
                  <a
                    ...
                    href="/"
                  >
                    <span className="flex-1">AI Insights Pro</span>
                    <svg
                      width="22"
                      height="7"
                      viewBox="0 0 22 7"
                ...
                <li>
                  <a
                    ...
                    href="/"
                  >
                    <span className="flex-1">Tech Armor Security</span>
                    <svg
                      width="22"
                      height="7"
                      viewBox="0 0 22 7"
                ...
                <li>
                  <a
                    ...
                    href="/"
                  >
                    <span className="flex-1">Blockchain Forge</span>
                    <svg
                      width="22"
                      height="7"
                      viewBox="0 0 22 7"
                ...
                <li>
                  <a
                    ...
                    href="/"
                  >
                    <span className="flex-1">DigitalIQ Consulting</span>
                    <svg
                      width="22"
                      height="7"
                      viewBox="0 0 22 7"
                ...
                <li>
                  <a
                    ...
                    href="/"
                  >
                    <span className="flex-1">RapidApp Innovate</span>
                    <svg
                      width="22"
                      height="7"
                      viewBox="0 0 22 7"
                ...
                <li>
                  <a
                    ...
                    href="/"
                  >
                    <span className="flex-1">RoboLogic Labs</span>
                    <svg
                      width="22"
                      height="7"
                      viewBox="0 0 22 7"
            ...
            <div className="relative grid min-h-[410px] place-items-center overflow-hidden rounded-5 bg-accent-100 p-10 bg-accent-700 after:absolute after:inset-0 after:z-1 after:bg-accent-700/95 before:absolute before:inset-0 before:z-[2] before:[background:linear-gradient(180deg,rgba(185,18,2,0.00)_0%,rgba(185,18,2,0.22)_100%)]">
              <Image 
                    src={service7} 
            ...
            <div className="bg-accent-100 p-10 bg-accent-700">
              <h3 className="text-[1.5rem] font-secondary text-white">
                Search Service
              </h3>
              ...
              <div className="flex items-center gap-4">
                <div className="relative w-full">
                  <input
                    placeholder="Search..."
                    className="flex items-center md:min-h-[3.75rem] w-full rounded-5 px-4 md:px-5 bg-transparent text-accent-800 placeholder:text-accent-800 text-body placeholder:text-body border border-solid border-accent-900 border-opacity-20 border-accent-200 focus:border-accent-900 focus:ring-0 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 transition-all duration-300 !min-h-[40px] !py-0"
                    name="sarch"
                  />
                </div>
                <button className="relative z-[2] text-white overflow-hidden text-base leading-[1.1] font-bold font-secondary tracking-wide uppercase [transition:all_0.3s_linear] inline-flex items-center justify-center gap-3 md:min-h-[3.75rem] px-6 md:px-7 py-2 md:py-3 transition-colors ease-in-out ring-offset-primary-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 bg-primary after:absolute after:h-full after:w-0 after:bottom-0 after:right-0 after:bg-black/[.15] after:-z-1 after:[transition:all_.3s_ease-in-out] hover:text-white hover:after:w-full hover:after:left-0 rounded-5 !min-h-[40px]">
                  <span className="relative z-1">SEARCH</span>
                </button>
              </div>
            </div>
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 bg-accent-700">
                <p>
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="flex-1 text-md font-bold text-white">
                      Best Emplementation
                    </h3>
                  </div>
                  <p>
